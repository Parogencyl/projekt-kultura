<?php
    $nazwa = Request::segment(3);

    $warsztat = DB::table('warsztaty')->where('nazwa', $nazwa)->first();
...
<section class="container mb-5 mt-5">
    ...
    <div class="row justify-content-center">
        ...
        <form action="{{ url('/warsztaty/zakup/sprawdzenie') }}" method="POST" class="form col-12 col-md-10 col-xl-9">
            ...
            <input type="hidden" name="name_of_warsztat" value="{{ $nazwa }}">
            <input type="hidden" name="price" value="{{ $warsztat->cena }}" id="priceToPay">
